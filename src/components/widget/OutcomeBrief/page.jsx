...
function OutcomeBrief() {
  ...
  return (
    ...
    <section className="w-[1280px] px-6 md:px-4 sm:px-2 py-16 flex justify-center items-center  gap-6">  
    <Image className='w-1/2 lg:hidden' src={images.Robot} alt="robot"/>

    <div>
        <h2 className='text-5xl lg:text-4xl text_gradient font-bold py-3'>The Outcome for Participants of the Program</h2>
        <p className='mt-4 text-gray-400'>The graduates of this program will own products (Full-Stack App Templates, AR and VR Experiences, and APIs) that are marketed globally by the Panaverse DAO and, if they like, will also be able to start off by offering services at a rate of $50 per hour ($96,000 per year). This would give Pakistani professionals and students a fantastic opportunity to better their financial situation while also giving the economy a much-needed boost by expanding software exports.</p>

        <div className='mt-5'>
            {impLinks.map((item, index)=>(
                <div key={index} className="flex gap-4 text-gray-400 hover:text-[#44DA64] transition-all">
                    <a href={item.link} className="underline underline-offset-2 mt-1">
